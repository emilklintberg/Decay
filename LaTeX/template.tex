...
\begin{align}
& \| T_{i,j} \|_\infty \leq K_{\Lambda_k} \omega_{\Lambda_k}^{i - j} \\
& \| T_{i,j} \|_1 \leq K_{\Lambda_k} \omega_{\Lambda_k}^{i - j}
\end{align}
\end{subequations}
where $\sigma_{\min}(\Lambda_k)$ and $\kappa_{\Lambda_k}$ are the the smallest singular value and the condition number of $\Lambda_k$ respectively, $K_{\Lambda_k} = \max \{ \sigma_{\min}(\Lambda_k)^{-1}, 1 + \sqrt{\kappa_{\Lambda_k}} \} l_k \omega_{\Lambda_k}^{1/l_k}$ and $\omega_{\Lambda_k} = \left( \frac{\sqrt{\kappa_{\Lambda_k}} - 1}{\sqrt{\kappa_{\Lambda_k}} + 1} \right)^{\frac{1}{3}}$.
\end{proposition}
...
\begin{subequations}
\begin{align}
& \| V_{i,j} \|_\infty \leq \gamma^2 \bar{K}_{\Lambda_k} \omega_{\Lambda_k}^{i-j} \\
& \| V_{i,j} \|_1 \leq \gamma^2 \bar{K}_{\Lambda_k} \omega_{\Lambda_k}^{i-j}
\end{align}
\end{subequations}
where $\bar{K}_{\Lambda_k} = (2 + \omega_{\Lambda_k} + \omega_{\Lambda_k}^{-1}) \omega_{\Lambda_k}^{-1} K_{\Lambda_k}$.
\end{proposition}
\begin{proof}
Bla bla bla
\qed
...
\begin{subequations}
\begin{align}
& \| W_{i,j} \|_\infty \leq \sum_{k=1}^M \gamma^4 \gamma_{\Phi_k^{-1}}^2 \bar{K}_{\Lambda_k} \omega_{\Lambda_k}^{i-j} \\
& \| W_{i,j} \|_1 \leq \sum_{k=1}^M \gamma^4 \gamma_{\Phi_k^{-1}}^2 \bar{K}_{\Lambda_k} \omega_{\Lambda_k}^{i-j}
\end{align}
\end{subequations}
\end{proposition}
\begin{proof}
